        ...
        for i2=1:length(K_Val)
            ...
            while ContinueTesting       % sequential test starts here
                ...
                while Monitoring    	% continuously monitor sample variance 
                    ...
                    CovMatrix	= cov( [AllData;Data_1;Data_2] );   % the covariance matrix to monitor. Note: all accrued data from groups 1 and 2 are used for the estimate
